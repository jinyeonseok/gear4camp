...
public interface CartMapper {
    ...
    Optional<Cart> findByUserIdAndProductId(@Param("userId") Long userId, @Param("productId") Long productId); // 중복 확인용

    List<Cart> findByUserId(Long userId);              // 사용자 장바구니 전체 조회

    void updateQuantity(@Param("id") Long id, @Param("quantity") Integer quantity);    // 수량 변경
